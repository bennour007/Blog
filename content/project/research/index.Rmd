...
$$Y = F(X)$$
Where $Y$ is the final output level (the quantity of goods produced), $X$ is the amount of resources, or inputs given to the production process, and the function $F(.)$ represents the technology of the production process that takes the resources and turn them into goods.
...
![How directional distance project a DMU onto the estimated frontier](~/projects/new_ws/content/project/research/directions.png)
